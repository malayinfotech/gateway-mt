	...
	testCases := []struct {
		...
		},
		{
			...
			r: &http.Request{
				...
				Header: map[string][]string{
					"Forwarded": {
						"by=storx;for=172.31.254.15,for=172.17.5.10;host=example.test;proto=https",
						"for=172.28.15.15",
					},
				},
			},
		...
		},
		{
			...
			r: &http.Request{
				...
				Header: map[string][]string{
					"Forwarded": {
						"by=storx;for=49d4:4f54:d2fa:4f5f:fe12:d3bf:d523:192c,for=172.17.5.10;host=example.test;proto=https",
						"for=172.28.15.15",
					},
				},
			},
	...
	testCases := []struct {
		...
		},
		{
			...
			r: &http.Request{
				...
				Header: map[string][]string{
					"Forwarded": {
						`by=storx;for="172.31.254.15:9089",for=172.17.5.10;host=example.test;proto=https`,
						"for=172.28.15.15",
					},
				},
			},
		...
		},
		{
			...
			r: &http.Request{
				...
				Header: map[string][]string{
					"Forwarded": {
						`by=storx;for="6934:9e20:e075:a5f6:c8d2:21d1:124d:94b7",for=172.17.5.10;host=example.test;proto=https`,
						"for=172.28.15.15",
					},
				},
			},
		...
		},
		{
			...
			r: &http.Request{
				...
				Header: map[string][]string{
					"Forwarded": {
						`by=storx;for="[6934:9e20:e075:a5f6:c8d2:21d1:124d:94b7]:7896",for=172.17.5.10;host=example.test;proto=https`,
						"for=172.28.15.15",
					},
				},
			},
		...
		},
		{
			...
			r: &http.Request{
				...
				Header: map[string][]string{
					"Forwarded": {
						"by=storx;xfor=172.31.254.15;for=172.17.5.10,for=172.17.5.12;host=example.test;proto=https",
						"For=172.28.15.15",
					},
				},
			},
