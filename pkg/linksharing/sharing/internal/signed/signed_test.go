...
func TestErrMissingAuthorizationHeader(t *testing.T) {
	...
	r, err := http.NewRequestWithContext(context.TODO(), http.MethodGet, "https://link.storxshare.io/raw/AKIAIOSFODNN7EXAMPLE/b/o", nil)
...
func TestVerifySigningInfo(t *testing.T) {
	...
	// })
	//
	// r, err := http.NewRequest(http.MethodGet, "https://link.eu1.storxshare.io/raw/AKIAIOSFODNN7EXAMPLE/b/o", nil)
	// if err != nil {
	// 	panic(err)
	// }
	//
	...
	for i, tt := range [...]struct {
		...
		r, err := http.NewRequestWithContext(context.TODO(), http.MethodGet, "https://link.eu1.storxshare.io/raw/AKIAIOSFODNN7EXAMPLE/b/o", nil)
