...
// determineBucketAndObjectKey is a helper function to parse storx_root and the url into the bucket and object key.
// For example, we have http://mydomain.com/prefix2/index.html with storx_root:bucket1/prefix1/
