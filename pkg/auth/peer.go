...
import (
	...
	"gateway-mt/pkg/auth/drpcauth"
	"gateway-mt/pkg/auth/httpauth"
	"gateway-mt/pkg/auth/satellitelist"
	"gateway-mt/pkg/httplog"
	"gateway-mt/pkg/middleware"
	"gateway-mt/pkg/trustedip"
	"private/process/gcloudlogging"
)
...
type Config struct {
	...
	AllowedSatellites []string      `help:"list of satellite NodeURLs allowed for incoming access grants" default:"https://www.storx.io/dcs-satellites"`
