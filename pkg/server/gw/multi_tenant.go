...
import (
	...
	"common/rpc/rpcpool"
	"common/useragent"
	"gateway-mt/pkg/server/gwlog"
	"gateway-mt/pkg/server/middleware"
	"gateway/miniogw"
	minio "minio/cmd"
	"minio/cmd/logger"
	"minio/pkg/auth"
...
// Shutdown is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).Shutdown.
...
// StorageInfo is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).StorageInfo.
...
// MakeBucketWithLocation is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).MakeBucketWithLocation.
...
// GetBucketInfo is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).GetBucketInfo.
...
// ListBuckets is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).ListBuckets.
...
// DeleteBucket is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).DeleteBucket.
...
// ListObjects is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).ListObjects.
...
// ListObjectsV2 is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).ListObjectsV2.
...
// GetObjectNInfo is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).GetObjectNInfo.
...
// GetObjectInfo is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).GetObjectInfo.
...
// PutObject is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).PutObject.
...
// CopyObject is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).CopyObject.
...
// DeleteObject is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).DeleteObject.
...
// DeleteObjects is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).DeleteObjects.
...
// ListMultipartUploads is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).ListMultipartUploads.
...
// NewMultipartUpload is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).NewMultipartUpload.
...
// PutObjectPart is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).PutObjectPart.
...
// GetMultipartInfo is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).GetMultipartInfo.
...
// ListObjectParts is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).ListObjectParts.
...
// AbortMultipartUpload is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).AbortMultipartUpload.
...
// CompleteMultipartUpload is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).CompleteMultipartUpload.
...
// IsTaggingSupported is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).IsTaggingSupported.
func (l *MultiTenancyLayer) IsTaggingSupported() bool {
	return l.layer.IsTaggingSupported()
}

// PutObjectTags is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).PutObjectTags.
...
// GetObjectTags is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).GetObjectTags.
...
// DeleteObjectTags is a multi-tenant wrapping of storx.io/gateway.(*gatewayLayer).DeleteObjectTags.
