...
import (
	...
	"common/testcontext"
	"common/testrand"
	"gateway-mt/internal/minioclient"
	"gateway-mt/internal/register"
	"gateway-mt/pkg/auth"
	"gateway-mt/pkg/auth/badgerauth"
	"gateway-mt/pkg/authclient"
	"gateway-mt/pkg/server"
...
func TestUploadDownload(t *testing.T) {
	...
	testplanet.Run(t, testplanet.Config{
		...
		auth, err := auth.New(ctx, zaptest.NewLogger(t).Named("auth"), authConfig, fpath.ApplicationDir("storx", "authservice"))
		require.NoError(t, err)
