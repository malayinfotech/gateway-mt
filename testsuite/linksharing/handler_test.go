...
import (
	...
	"common/testrand"
	"drpc"
	"gateway-mt/pkg/authclient"
	"gateway-mt/pkg/linksharing/objectmap"
	"gateway-mt/pkg/linksharing/sharing"
...
func testHandlerRequests(t *testing.T, ctx *testcontext.Context, planet *testplanet.Planet) {
	...
	testCases := []struct {
		...
		},
		{
			...
			txtRecords: map[string][]string{
				"txt-mydomain.com.": {
					"storx-access:" + privateAccessName,
					"storx-root:testbucket",
				},
			},
			status:           http.StatusForbidden,
		...
		},
		{
			...
			txtRecords: map[string][]string{
				"txt-mydomain.com.": {
					"storx-access:" + serializedListOnlyAccess,
					"storx-root:testbucket/test/foo",
				},
			},
			status:           http.StatusForbidden,
		...
		},
		{
			...
			txtRecords: map[string][]string{
				"txt-mydomain.com.": {
					"storx-access:" + downloadOnlyAccessName,
					"storx-root:testbucket",
				},
			},
			status:           http.StatusForbidden,
		...
		},
		{
			...
			txtRecords: map[string][]string{
				"txt-mydomain.com.": {
					"storx-access:" + serializedAccess,
					"storx-root:testbucket/prefix",
				},
			},
			status:           http.StatusOK,
			body:             "HELLO!",
