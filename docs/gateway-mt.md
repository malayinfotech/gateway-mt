...
S3-compatible gateway for Storx V3 Network, based on [MinIO](https://github.com/minio/minio).

If you're looking for the easier-to-setup Single Tenant Gateway, check out [Gateway-ST](https://github.com/storx/gateway-st).
...
* [Using the S3 Gateway](https://docs.storx.io/dcs/api-reference/s3-gateway)
* [S3 Compatibility](https://github.com/storx/gateway-st/blob/main/docs/s3-compatibility.md)
...
## Run auth service
    ...
    - `--allowed-satellites` is the satellite node url (this must include the identity for non-DCS satellites).
        ...
        - allowed-satellites may alternatively include lists of satellites, such as https://www.storx.io/dcs-satellites
        ```
...
## Register an access grant with auth service
    ...
    You can use that credential to configure an s3 client to talk to storx network through the gateway-mt
...
Table](https://github.com/storx/gateway-st/blob/main/docs/s3-compatibility.md).
...
[our community forum](https://forum.storx.io/) or
email us at support@storx.io.
