...
var (
	...
	registerCfg struct {
		Address   string `help:"authservice to register access to" dev:"drpc://localhost:20002" release:"drpcs://auth.storxshare.io:7777"`
...
func init() {
	defaultConfDir := fpath.ApplicationDir("storx", "authservice")
